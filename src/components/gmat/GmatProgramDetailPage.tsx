...
import type { GmatProgramPageConfig } from "@/lib/gmat-program-pages";

export function GmatProgramDetailPage({ program }: { program: GmatProgramPageConfig }) {
  return (
    <>
      ...
      <section className="section-y">
        ...
        <div
          className={cn(
            "container-page grid gap-6 lg:grid-cols-[1.4fr_1fr]",
            program.showMicrobatchPoster && program.posterImage && "mt-8 sm:mt-10 lg:mt-12",
          )}
        >
      ...
      <CtaBand
        ...
        subtitle="Book a consultation with Tarun Kaushik and discover the GMAT preparation path best suited to your MBA goals."
      />
    </>
  );
}
