...
import { greMainContent as c } from "@/lib/gre-main-content";
import { GRE_MAIN_IMAGES } from "@/lib/gre-main-images";
import { cn } from "@/lib/utils";

const strategyIcons = [Rocket, Flag, BarChart3, BookOpen] as const;

const whoCandidates = [
  { title: "MS & PhD Aspirants", icon: GraduationCap },
  { title: "MBA Applicants", icon: Briefcase },
  { title: "Working Professionals", icon: Globe2 },
    ...
    <>
      ...
      <section className="section-y !py-8 sm:!py-10">
        <div className="container-page space-y-8 sm:space-y-10">
          ...
          <PageBlock>
            <SectionHeader eyebrow="Exam Overview" title={c.aboutGre.title} center />
            <SplitSection image={GRE_MAIN_IMAGES.aboutIllustration} imageAlt="GRE preparation illustration">
              <p className="text-sm leading-relaxed text-muted-foreground sm:text-base">{c.aboutGre.intro}</p>
              <div className="mt-4">
                <Pills items={c.aboutGre.skills} />
              </div>
              <p className="mt-4 text-sm font-medium text-navy sm:text-base">{c.aboutGre.footer}</p>
            </SplitSection>
          </PageBlock>
          ...
          <div className="rounded-2xl border border-border bg-card p-5 shadow-card sm:p-6">
            ...
            <ul className="mt-5 space-y-2">
              {c.greOverview.additionalFeatures.map((f) => (
          ...
          <PageBlock>
            ...
            <div className="grid gap-3 rounded-xl border border-primary/15 bg-gradient-to-br from-primary/[0.06] to-surface p-4 sm:grid-cols-3 sm:p-5">
              ...
              <div className="text-center">
                <p className="text-xs font-bold uppercase tracking-wider text-primary">Analytical Writing</p>
          ...
          <PageBlock>
            <SectionHeader
              ...
              title="Top Universities Accepting GRE"
              subtitle="Our students target and gain admits to leading institutions worldwide."
              center
            />
          ...
          <SplitSection image={GRE_MAIN_IMAGES.aboutIllustration} imageAlt="Why the GRE matters for graduate admissions">
            <SectionHeader eyebrow="Why It Matters" title="Why GRE Matters" />
          ...
          <div className="rounded-2xl border border-border bg-surface p-5 sm:p-6">
            <SectionHeader
              ...
              subtitle="What you get with structured GRE coaching"
              center
            />
            <SplitSection
              reverse
              className="mt-2"
              image={GRE_MAIN_IMAGES.partnerIllustration}
              imageAlt="AceYourTest as your GRE preparation partner"
            >
              ...
              >
                Explore all GRE programs <ArrowRight className="h-4 w-4" aria-hidden />
              </Link>
            </SplitSection>
          </div>
          ...
          <PageBlock>
            ...
            <div className="grid gap-5 lg:grid-cols-2 lg:items-start">
              <Illustration
                src={GRE_MAIN_IMAGES.strategyIllustration}
                alt="Structured GRE preparation strategy roadmap"
              />
          ...
          <PageBlock>
            <SectionHeader eyebrow="Ideal Candidates" title="Who Should Take the GRE?" center />
            ...
            <p className="mx-auto max-w-2xl text-center text-sm leading-relaxed text-muted-foreground">
              Start your GRE journey today — prepare smarter, score 330+, and get into your dream university.
            </p>
          </PageBlock>
          ...
          <div className="rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/[0.07] via-card to-surface p-5 sm:p-6">
            <SectionHeader
              ...
              title="Why Choose AceYourTest for GRE Coaching?"
          ...
          <SplitSection
            reverse
            image={GRE_MAIN_IMAGES.trustedIllustration}
            imageAlt="Why thousands of GRE aspirants trust AceYourTest"
          >
          ...
          <div className="rounded-2xl border border-border bg-white p-4 shadow-card sm:p-6">
            ...
            <div className="mt-5 w-full">
              <img
                src={GRE_MAIN_IMAGES.featuresHub}
                alt="AceYourTest GRE coaching features — target score assurance, live classes, customized learning paths"
                loading="lazy"
                decoding="async"
          ...
          <SplitSection image={GRE_MAIN_IMAGES.journeyIllustration} imageAlt="GRE success journey">
          ...
          <PageBlock>
            <SectionHeader
              ...
              title="GRE Success Stories: How Our Students Scored 330+ and Beyond"
              center
            />
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
            <div className="space-y-4">
              ...
              <Illustration
                src={GRE_MAIN_IMAGES.standoutIllustration}
                alt="Stand out from the crowd with GRE coaching"
              />
              <ul className="space-y-2">
                {c.standOut.map((item) => (
            ...
            <div className="space-y-4">
              ...
              <Illustration
                src={GRE_MAIN_IMAGES.rocketIllustration}
                alt="Gain a competitive advantage in GRE preparation"
              />
              <ul className="space-y-2">
              ...
              <div className="flex items-center gap-2 rounded-lg border border-accent/30 bg-accent/10 px-3 py-2.5 text-sm font-medium text-navy">
                ...
                Free GRE study resources, strategy guides & tips with every program
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-5 lg:grid-cols-[1.4fr_1fr] lg:gap-6">
            <div>
              <SectionHeader eyebrow="FAQ" title="GRE Online Coaching: Your Questions Answered" />
            ...
            <aside className="lg:sticky lg:top-24 h-fit">
              <EnquiryForm title="Get your GRE study plan" />
            </aside>
          </div>
        </div>
      </section>
      ...
      <CtaBand
        title="Ready to plan your GRE journey?"
